...
export class CacheManager {
     ...
     */
    generateKey(expression, dependencies) {
    ...
    _estimateValueSize(value) {
        if (typeof value === "string") {
            ...
            return value.reduce((sum, item) => sum + this._estimateValueSize(item), 0);
        }
        else if (typeof value === "object" && value !== null) {
            return Object.values(value).reduce((sum, item) => sum + this._estimateValueSize(item), 0);
        }
        return 0;
    }
    /**
